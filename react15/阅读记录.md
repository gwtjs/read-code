...
react源代码地址在[这里](https://github.com/gwtjs/read-code/tree/master/react15/%E4%BE%8B%E5%AD%90/react-demo/modules)

在React源码中，require()的参数都是直接写的文件名而不是相对或绝对路径，实现方式在[此处](./阅读记录/全局模块系统.md)讲解。

## 执行之前

[代码地址](https://github.com/gwtjs/read-code/tree/master/react15/%E4%BE%8B%E5%AD%90/react-demo)
...
## [ReactDOM.js](源码/src/renderers/dom/ReactDOM.js)
...
## [ReactMount.js](源码/src/renderers/dom/client/ReactMount.js)
